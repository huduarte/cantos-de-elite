                ...
                <div id="cantosdeelite">
                    ...
                    <div id="bgi">
                        <div id="content">
                            ...
                            <div id="buttonbuy">
                                <a href="">
                                    <span>ADQUIRA O CURSO AGORA!</span>
                                </a>
                            </div>
                            <div id="price">
                                ...
                                <p id="info1">Acesso Imediato Por Apenas <br/> 12 pagamentos de <strong>R$12,50</strong></p>
                                <p id="info2">Menos de <strong>30</strong> vagas disponíveis <br/><br/><br/></p>
                            </div>
                    </div>
                </div>
                </div>
                        ...
                        <div id="modulos">
                            <div id="mod1">
                                <p>
                                    ...
                                    <br/>
                                    <br/> <strong id="mod1-title">Criação De Conta:</strong>
                                    <br/>
                                    <br/> 1 - Verificação De Conta;
                                    <br/>
                                    <br/>
                                    <br/> 2 - Como Depositar;
                                    <br/>
                            ...
                            <div id="mod2">
                                <p>
                                    <div id="module-name">
                                        ...
                                        <br/>
                                        <br/> 1 - Estratégia De Canto Limite;
                                        <br/>
                                        <br/>
                                        <br/> 2 - Estratégia Diamante;
                                        <br/>
                                        <br/>
                                        <br/> 3 - Estratégia Under Cantos;
                                        <br/>
                                        <br/>
                                        <br/> 4 - Estratégia Ambos Marcam;
                                        <br/>
                                        <br/>
                                        <br/> 5 - Estratégia De Alavancagem
                                        <br/>
                                        <br/>
                                </p>
                            </div>
                            <div id="mod2">
                                <p>
                                    <div id="module-name">
                                        ...
                                        <br/>
                                        <br/>  <strong id="mod2-title">Gestão de banca:</strong>
                                        <br/>
                                        <br/> 1 - Gestão De Banca
                                        <br/>
                                        <br/>
                                </p>
                            </div>
